#include "on_policy_qlearning_solve.h"
#include <boost/thread.hpp>
#include "ui/ui_td_state.h"

on_policy_qlearning_solve::on_policy_qlearning_solve(double gama, double error, solve_notify* notify) :
	temporal_difference_solve(gama, error, notify)
{
}

void on_policy_qlearning_solve::runing()
{
